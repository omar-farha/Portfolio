...
function AboutMe() {
  return (
    <div className="w-full px-[12%] py-10 scroll-mt-20 text-white">
      <motion.h4
        variants={fadeInUp}
        initial="start"
        whileInView="end"
      ...
      <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
        ...
        <div className="flex-1">
          ...
          >
            ...
            turning ideas into clean, functional designs that offer a smooth and
            intuitive user experience. With a strong understanding of modern web
            practices and a commitment to continuous learning, I strive to
            deliver high-quality digital solutions that balance both visual
          ...
          >
            ...
            >
              ...
              <p className="text-gray-300 text-sm">Meta Front-End Developer</p>
            </motion.li>
            <motion.li
              variants={fadeInUp}
              initial="start"
          ...
          >
            ...
            >
              <Image src={js} alt="Profile" width={20} height={20} />
            </motion.li>
            <motion.li
              variants={fadeInUp}
              initial="start"
              ...
              className="flex items-center justify-center w-12 sm:w-14 aspect-square border border-gray-400 rounded-lg cursor-pointer hover:scale-125 duration-500"
            >
              <Image src={ts} alt="Profile" width={20} height={20} />
            </motion.li>
            <motion.li
              variants={fadeInUp}
              initial="start"
              ...
              className="flex items-center justify-center w-12 sm:w-14 aspect-square border border-gray-400 rounded-lg cursor-pointer hover:scale-125 duration-500"
            >
              <Image src={tailwind} alt="Profile" width={20} height={20} />
            </motion.li>
            <motion.li
              variants={fadeInUp}
              initial="start"
              ...
              className="flex items-center justify-center w-12 sm:w-14 aspect-square border border-gray-400 rounded-lg cursor-pointer hover:scale-125 duration-500"
            >
              <Image src={react} alt="Profile" width={20} height={20} />
            </motion.li>
            <motion.li
              variants={fadeInUp}
              initial="start"
              ...
              className="flex items-center justify-center w-12 sm:w-14 aspect-square border border-gray-400 rounded-lg cursor-pointer hover:scale-125 duration-500"
            >
              <Image src={redux} alt="Profile" width={20} height={20} />
            </motion.li>
            <motion.li
              variants={fadeInUp}
              initial="start"
              ...
              className="flex items-center justify-center w-12 sm:w-14 aspect-square border border-gray-400 rounded-lg cursor-pointer hover:scale-125 duration-500"
            >
              <Image src={next} alt="Profile" width={20} height={20} />
            </motion.li>
            <motion.li
              variants={fadeInUp}
              initial="start"
              ...
              className="flex items-center justify-center w-12 sm:w-14 aspect-square border border-gray-400 rounded-lg cursor-pointer hover:scale-125 duration-500"
            >
              <Image src={git} alt="Profile" width={20} height={20} />
            </motion.li>
          </motion.ul>
        </div>
      </div>
